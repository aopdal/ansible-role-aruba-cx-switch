...
- Removing a port-access role's `description` from NetBox left the stale
  ...
  comparison; see
  [docs/PORT_ACCESS_CONFIGURATION.md](docs/PORT_ACCESS_CONFIGURATION.md#removing-a-role-attribute-eg-description).
...
- OSPF interface config (area/network-type/authentication/passive) was
  ...
  [docs/OSPF_CONFIGURATION.md](docs/OSPF_CONFIGURATION.md#interaction-with-vrf-changes).
