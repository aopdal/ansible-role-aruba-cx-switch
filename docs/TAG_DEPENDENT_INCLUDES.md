...
## Verifying Tag Behavior

Copy-paste commands and a matrix for manually verifying the tag-narrowing
design described above, beyond the checklist in [Testing](#testing).
